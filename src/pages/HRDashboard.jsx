        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 border-l border-gray-200 pl-4">
              <Link to="/admin/crm" className="flex items-center gap-1.5 px-3 py-2 text-sm bg-maroon-50 text-maroon-700 rounded hover:bg-maroon-100 transition border border-maroon-200 font-medium">
                CRM Portal
              </Link>
