            ...
            <section className="py-20 container mx-auto px-4">
                <div className="flex flex-col md:flex-row gap-12 items-center">
                    ...
                    <div className="md:w-1/2">
                        ...
                        <h2 className="text-3xl font-serif text-maroon-950 mt-2 mb-6">A Legacy of Trust and Excellence</h2>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl font-serif text-maroon-950">Our Vision & Values</h2>
                    </div>
                    <div className="grid md:grid-cols-3 gap-8">
                        <div className="bg-white p-8 shadow-lg border-t-4 border-gold-500 hover:-translate-y-2 transition-transform">
                            <h3 className="text-xl font-serif font-bold mb-4 text-maroon-950">Uncompromising Quality</h3>
                        ...
                        <div className="bg-white p-8 shadow-lg border-t-4 border-gold-500 hover:-translate-y-2 transition-transform">
                            <h3 className="text-xl font-serif font-bold mb-4 text-maroon-950">Customer Trust</h3>
                            <p className="text-gray-600">
