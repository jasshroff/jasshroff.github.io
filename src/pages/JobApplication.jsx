      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex items-center justify-center px-4 py-20">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-10 shadow-lg border border-gold-200 max-w-md w-full text-center">
            ...
            <h2 className="text-2xl font-serif font-bold text-dark-900 mb-3">Sign In to Apply</h2>
            ...
            <button onClick={handleGoogleSignIn} disabled={signingIn} className="w-full flex items-center justify-center gap-3 bg-white border-2 border-gray-300 hover:border-gold-500 px-6 py-3.5 rounded-lg font-medium text-dark-900 transition-all hover:shadow-md disabled:opacity-50">
